...
namespace dxe
{
    ...
    public:
        ...
        {
            if (other.lock() && ContainsByGuid(other.lock()->GetGUID()) && (FindCloneByGuid<T>(other.lock()->GetGUID())
                == nullptr))
            {
                other.lock()->ReRef();
                return true;
        ...
        static bool ChangePtrToClone(std::weak_ptr<T>& other)
        {
            ...
            if (other.lock() && (ContainsByGuid(other.lock()->GetGUID()) && (cloneObject = FindCloneByGuid<T>(
                other.lock()->GetGUID())) != nullptr))
            {
                other = cloneObject;
                return true;
            }
